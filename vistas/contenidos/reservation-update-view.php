                ...
                <div class="container-fluid form-neon">
                    <?php if ($campos['prestamo_pagado'] != $campos['prestamo_total']) { ?>
                        <div class="container-fluid">
                            ...
                            <p class="text-center">Este préstamo presenta un pago pendiente por la cantidad de <strong><?php echo MODENA . number_format(($campos['prestamo_total'] - $campos['prestamo_pagado']), 2, '.', ','); ?></strong>, puede agregar un pago a este préstamo haciendo clic en el siguiente botón.</p>
                            <p class="text-center">
                    ...
                    <div class="container-fluid">
                        ...
                        $datos_cliente = $ins_cliente->datos_cliente_controlador("Unico", $lc->encrypt_decrypt('encrypt', $campos['cliente_id']));

                        $datos_cliente = $datos_cliente->fetch();
                        ?>
                        <div>
                            <span class="roboto-medium">CLIENTE:</span> &nbsp; <?php echo $datos_cliente['cliente_nombre'] . " " . $datos_cliente['cliente_apellido']; ?>
                        </div>
                        <div class="table-responsive">
                            <table class="table table-dark table-sm">
                                ...
                                <tbody>
                                    ...
                                    $datos_detalle = $ins_prestamo->datos_prestamo_controlador("Detalle", $lc->encrypt_decrypt('encrypt', $campos['prestamo_codigo']));
                                    ...
                                    foreach ($datos_detalle as $items) {
                                        ...
                                        <tr class="text-center">
                                            ...
                                            <td><?php echo  MODENA . $items['detalle_costo_tiempo'] . " x 1 " . $items['detalle_formato']; ?></td>
                                            <td><?php echo MODENA . $subtotal; ?></td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
                            </table>
                    ...
                    <form class="FormularioAjax" action="<?php echo SERVERURL; ?>ajax/prestamoAjax.php" method="POST" data-form="update" autocomplete="off">
                        <input type="hidden" name="prestamo_codigo_up" value="<?php echo $lc->encrypt_decrypt('encrypt', $campos['prestamo_codigo']); ?>">
                        <fieldset>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" value="<?php echo $campos['prestamo_hora_inicio']; ?>" readonly="" id="prestamo_hora_inicio">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <fieldset>
                            ...
                            <div class="container-fluid">
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="prestamo_estado_up" id="prestamo_estado">
                                                ...
                                                <option value="Prestamo" <?php if ($campos['prestamo_estado'] == "Prestamo") {
                                                                                echo 'selected=""';
                                                                            } ?>> Prestamo<?php if ($campos['prestamo_estado'] == "Prestamo") {
                                                                                                echo '(Actual)';
                                                                                            } ?></option>
                                    ...
                                    <div class="col-12 col-md-4">
                                        <div class="form-group">
                                            <label for="prestamo_total" class="bmd-label-floating">Total a pagar en <?php echo MODENA; ?></label>
                                    ...
                                    <div class="col-12 col-md-4">
                                        <div class="form-group">
                                            <label for="prestamo_pagado" class="bmd-label-floating">Total depositado en<?php echo MODENA ?></label>
                            ...
                            <div class="modal-body">
                                <div class="table-responsive">
                                    <table class="table table-hover table-bordered table-sm">
                                        ...
                                        <tbody>
                                            <?php
                                            $datos_pagos = $ins_prestamo->datos_prestamo_controlador("Pago", $lc->encrypt_decrypt('encrypt', $campos['prestamo_codigo']));
                                ...
                                <div class="container-fluid">
                                    <input type="hidden" name="pago_codigo_reg" value="<?php echo
                                                                                        $lc->encrypt_decrypt('encrypt', $campos['prestamo_codigo']) ?>">
                                    <div class="form-group">
                                        <label for="pago_monto_reg" class="bmd-label-floating">Monto en <?php echo MODENA; ?></label>
