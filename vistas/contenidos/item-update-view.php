   ...
   <?php
    if ($_SESSION['privilegio_spm'] < 1 || $_SESSION['privilegio_spm'] > 2) {
        echo $ls->forzar_cierre_sesion_controlador();
        exit();
    }
    ?>
                           ...
                           <div class="col-12 col-md-6">
                               <div class="form-group">
                                   ...
                                   <select class="form-control" name="item_estado_up" id="item_estado">
                                       <option value="Habilitado" <?php if ($campos['item_estado'] == "Habilitado") { echo 'selected=""';}?>> Habilitado <?php if($campos['item_estado']=="Habilitado"){ echo '(Actual)';}?>
                                    </option>
