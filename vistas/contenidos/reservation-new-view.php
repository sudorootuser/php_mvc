      ...
      <div class="container-fluid form-neon">
          <div class="container-fluid">
              ...
              <div>
                  ...
                  <?php } else { ?>
                      <form class="FormularioAjax" data-form="loans" action="<?php echo SERVERURL; ?>ajax/prestamoAjax.php" method="POST" style="display: inline-block !important;">
                          ...
                          <button type="submit" class="btn btn-danger" na><i class="fas fa-user-times"></i></button>
                      </form>
                  <?php } ?>
              </div>
                          ...
                          <?php if (isset($_SESSION['datos_item']) && count($_SESSION['datos_item']) >= 1) {
                            ...
                            ?>
                                  <tr class="text-center">
                                      ...
                                      <td><?php echo $items['Costo'] . " x 1" . $items['Formato'] ?></td>
                              ...
                              <tr class="text-center bg-light">
                                  ...
                                  <td colspan="2"></td>
                                  <td><strong><?php echo MODENA . number_format($_SESSION['prestamo_total'], 2, '.', '') ?></strong></td>
                                  <td colspan="2"></td>
                              </tr>
                          <?php
                            } else {
                      ...
                      <div class="row">
                          ...
                          <div class="col-12 col-md-6">
                              <div class="form-group">
                                  ...
                                  <input type="datetime" class="form-control" name="prestamo_hora_inicio_reg"  value="<?php echo date("h:i a"); ?>" id="prestamo_hora_inicio">
                              </div>
                          </div>
                      </div>
                  </div>
