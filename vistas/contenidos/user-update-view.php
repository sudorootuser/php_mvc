	<!-- Page header -->
	<?php
	if ($lc->encrypt_decrypt('encrypt', $_SESSION['id_spm']) != $pagina[1]) {
	...
	<div class="container-fluid">
		...
		?>
			<form class="form-neon FormularioAjax" action="<?php echo SERVERURL; ?>ajax/usuarioAjax.php" method="POST" data-form="update" autocomplete="off">
								...
								<div class="col-12">
									<div class="form-group">
										...
										<select class="form-control" name="usuario_estado_up">
											<option value="Activo" <?php if ($campos['usuario_estado'] == "Activo") {
																		echo 'selected=""';
																	} ?>>Activo</option>
				...
				<?php if ($lc->encrypt_decrypt('encrypt', $_SESSION['id_spm']) != $pagina[1]) { ?>
